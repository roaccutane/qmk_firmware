...
*/
#define MATRIX_ROW_PINS { A5, A6, B0, B1, B2}
#define MATRIX_COL_PINS { A15, B3, B4, B5, B6, B7, B12, B13, B14, B15, A8, A9 }
#define ENCODERS_PAD_A { A1, A3 }
#define ENCODERS_PAD_B { A2, A4 }
